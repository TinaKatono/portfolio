...
export function SiteHeader() {
  return (
    <header
      className="pointer-events-none fixed right-0 top-0 z-50 flex h-20 items-center pr-6"
      aria-label="サイト内ナビゲーション"
    >
      <nav className="pointer-events-auto flex w-max max-w-[min(100vw-1.5rem,100%)] flex-wrap items-end justify-end gap-4 rounded-lg p-6 text-[16px] leading-none text-[#333]">
